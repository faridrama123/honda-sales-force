...
import com.langit7.hondasalesforce.view.fragment.SurveyFragment
import kotlinx.android.synthetic.main.action_bar.*
import kotlinx.android.synthetic.main.activity_main.*


class SurveyNewActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lsData = intent.getSerializableExtra("lsSurveyData") as ArrayList<survey>
    ...
    fun setupFragment() {
        ...
        lsFragment.add(SurveyFragment.Instantiate(lsData))
