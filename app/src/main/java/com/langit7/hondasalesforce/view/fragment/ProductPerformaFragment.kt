...
class ProductPerformaFragment : Fragment(), BaseFragmentInterface {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val rootView = inflater.inflate(R.layout.fragment_product_performa, container, false)
    ...
    companion object {
        fun Instantiate(tit:String): ProductPerformaFragment {
            val sd = ProductPerformaFragment()
            sd.title=tit
            return sd
        }
    }
