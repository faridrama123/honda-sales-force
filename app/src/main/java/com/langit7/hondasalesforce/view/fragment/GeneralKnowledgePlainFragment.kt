...
class GeneralKnowledgePlainFragment : Fragment(), BaseFragmentInterface {
...
//                llc.addView(v)
    ...
    companion object {
        fun Instantiate(tit: String, ls: List<productfeature>): GeneralKnowledgePlainFragment {
            val sd = GeneralKnowledgePlainFragment()
            sd.title = tit
            sd.lsprofit = ls
            return sd
        }
